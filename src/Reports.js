...
class Reports {
    ...
    constructor(employeeAddress, workingTime) {
        ...
        this.reportsContract = web3.eth.contract(abiArray).at(reportsContractAddress);
        web3.personal.unlockAccount(etherBase, "qwerty123");
        var createReport = this.reportsContract.createReport(employeeAddress, workingTime,
            {data: reportsContractAddress, gas: 2000000, from: this.etherBase});
        // var emp = contract.getEmployees.call();
        var reportCreatedOk = this.reportsContract.ReportCreatedOk();
        ...
        // alert(web3.fromWei(web3.eth.getBalance(reportsContractAddress)));
    }

    getEmployees() {
        return this.reportsContract.getEmployees.call() + " ";
    }

    getDayReports() {
        return this.reportsContract.getDayReports.call() + " ";
    }

    getGoodPoints() {
        return this.reportsContract.goodPoints.call();
    }

    getBadPoints() {
        return this.reportsContract.badPoints.call();
    }
}
